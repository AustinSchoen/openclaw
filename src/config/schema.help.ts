...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.compaction.model":
    "Optional model override used for compaction runs instead of the primary session model. Use a cheaper, faster model (e.g. claude-sonnet) to reduce token costs while keeping the primary model for reasoning.",
